...
int pinDHT = A5; //Pino do sensor de temperatura DHT
...
int limite_gas = 30; //Variável para selecionar a quantidade de Gás/Fumaça detectada
...
void loop(){  
  ...
  Serial.print("Temperatura: "); //Escreve o valor na porta Serial
  ...
  if (leitura_gas >= limite_gas){     // Caso o valor da leitura do gas seja maior que o limite definido
    ...
    // tone(buzzer,80); 
    Serial.print("Alarme disparado!!!"); //Apresenta mensagem na porta serial
